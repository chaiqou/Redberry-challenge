  ...
  return (
    <div className="h-screen ">
      <div className="absolute inset-0 bg-zinc-900 bg-stars-backs">
        ...
        <Link
          to="/personal"
          className="absolute left-[554px] top-[320px] text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl
        ...
        <Link
          to="/submit"
          className="absolute left-[780px]  top-[320px] text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l
        ...
        <div className="bg-rocket-man bg-no-repeat w-full h-full bg-right-bottom" />
      </div>
    </div>
  );
};
